...
| *[[_0shell/bin/0o][0o]]* | simplified executions |
...
| =MS-r= | | *reconfigure* |
| =CA-back= | | *lock* |
| =M-= *mouse* | =L= / =R= | *move* / *resize* window |
| =MS-esc= | | *close* window |
| =A-= *num* | =1= / =2= / =3= / =4= | *move* window to *nth* desktop |
| =M[S]-= *dir* | =h= / =j= / =k= / =l= / =y= / =u= / =b= / =n= | *move* [ *snap* ] window |
| =M-f= | | *fullscreen* toggle |
| =MS-f= | | *maximise* toggle |
...
| | | /APP/ |
|-|-|-------|
| =[A][S]-print= | | *take picture* of *screen* / *active* / *selection* |
| =M[S]-space= | | *close* [ *all* ] notification |
