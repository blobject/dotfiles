...
c.tabs.width = '10%'
c.tabs.min_width = 288
c.tabs.max_width = -1
c.tabs.indicator.width = 5
c.tabs.indicator.padding = {'bottom': 12, 'left': 0, 'right': 2, 'top': 4}
...
c.zoom.default = '200%'
c.zoom.levels = ['25%', '33%', '50%', '67%', '75%', '90%', '100%', '110%', '125%', '150%', '175%', '200%', '250%', '300%', '350%', '400%', '450%', '500%']
...
c.fonts.hints = '700 18pt default_family'
...
c.fonts.statusbar = '500 default_size default_family'
c.fonts.tabs.selected = '600 default_size sans'
c.fonts.tabs.unselected = '400 default_size sans'
