...
(custom-set-variables
 ...
 '(package-selected-packages (quote (go-mode rust-mode web-mode solarized-theme smart-mode-line rainbow-delimiters paredit org neotree multiple-cursors markdown-mode magit iy-go-to-char hlinum haskell-mode geiser flycheck expand-region counsel company clojure-mode cider browse-kill-ring auctex ace-window)))
