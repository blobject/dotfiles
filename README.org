...
1. *hw:* various firmware, intel-ucode, intel-video-accel, mesa-dri, xf86-input-mtrack
...
1. *snd:* sndio, alsa-sndio, aucatctl, alsa-utils, bluez-alsa, cmixer
  - fix and persist: =alsamixer= then ~alsactl store~
...
1. *dev:* base-devel, clang, llvm, chez, elixir, ghc, go, guile, lua, mono, msbuild-bin, openjdk, rustup, sbcl, squeak, swi-prolog, dfu-programmer, catch2, cmake, gdb, valgrind
1. *apps* & *fun:* gnupg2, qutebrowser, firefox-esr, imagemagick, imv, vlc, ffmpeg, zathura, pdf.js, libreoffice, foliate, texlive, gimp, inkscape, mypaint, fontforge, papirus-icon-theme, breeze-obsidian-cursor-theme, breeze-icons, cataclysm-dda, skype, steam, virtualbox-ose
...
/services:/ agetty-*, alsa, bluetoothd, bluez-alsa, dbus, dhcpcd, nanoklogd, ntpd, sddm, sndiod, socklog-unix, tlp, udevd, uuidd, wpa_supplicant
